...
const socket = io('https://enigmatic-everglades-57456.herokuapp.com');
let clickable = false;
let playerno = "";
let roomid = "";
let user1 = "";
...
const Asp1=()=>{
    ...
    playerno = 1;
    document.getElementsByClassName("status")[0].innerHTML = "waiting for p2 to join";
}
const Asp2=()=>{
...
const createroom = () => {
    ...
    if(roomname!==""&&roomname!==null&&username!==""&&username!==null){
...
socket.on("2p-joined", ([pts,usernames]) => {
    ...
    if (playerno === 1) {
        ...
        document.getElementById("p2name").innerText =` ${usernames[1]} (Opponent) : `;
    }
    else if(playerno===2) {
        document.getElementById("p1name").innerText = ` ${usernames[0]} (Opponent) : `;
